...
class RadarConfig:
    ...
    # [網通與矽光子/光通訊]
    "3596.TW", "3380.TW", "6285.TW", "4979.TWO", "4908.TWO", "4977.TW", "6442.TW", "8114.TW",
    # [機器人、智慧自動化與先進裝備]
    ...
    # [傳產塑化化學 14 檔 - 已移去重複的 1522.TW，補入台勝科 3532 / 精材 3374]
    "1314.TW", "1717.TW", "1304.TW", "1308.TW", "1309.TW", "1312.TW", "1305.TW", "1710.TW",
    "4722.TW", "4739.TW", "1718.TW", "1319.TW", "6605.TW", "7736.TW",
    # [造船與軍工航太 5 檔]
    "2208.TW", "2634.TW", "4541.TWO", "8222.TW", "2646.TW",
    # [軍工與強勢航太材料 5 檔 - 補入 3374.TW]
    "5009.TWO", "3005.TW", "1584.TWO", "8033.TW", "3374.TWO",
    # [航空、散裝航運與內需觀光 4 檔]
